<?php
/**
 * Title: Nice Hair / Home About Us
 * Slug: nice-hair/home-about-us
	...
	<div class="wp-block-group nh-home-about-us__shell">
		...
		<div class="wp-block-group nh-home-about-us__main">
			...
			<div class="wp-block-group nh-home-about-us__stats">
				...
				<div class="wp-block-group nh-home-about-us__stat">
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-value"} -->
					<p class="nh-home-about-us__stat-value">14</p>
					<!-- /wp:paragraph -->

					<!-- wp:heading {"level":3,"className":"nh-home-about-us__stat-title"} -->
					<h3 class="nh-home-about-us__stat-title">years of experience</h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"className":"nh-home-about-us__stat-text"} -->
					<p class="nh-home-about-us__stat-text">We’ve refined our technique over the years to deliver natural-looking, long-lasting results.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group nh-home-about-us__stat">
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-value"} -->
					<p class="nh-home-about-us__stat-value">100%</p>
					<!-- /wp:paragraph -->

					<!-- wp:heading {"level":3,"className":"nh-home-about-us__stat-title"} -->
					<h3 class="nh-home-about-us__stat-title">natural hair</h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"className":"nh-home-about-us__stat-text"} -->
					<p class="nh-home-about-us__stat-text">We use only our own premium Slavic hair — full control from sourcing to final product.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group nh-home-about-us__stat">
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-value"} -->
					<p class="nh-home-about-us__stat-value">Daily</p>
					<!-- /wp:paragraph -->

					<!-- wp:heading {"level":3,"className":"nh-home-about-us__stat-title"} -->
					<h3 class="nh-home-about-us__stat-title">support via WhatsApp</h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"className":"nh-home-about-us__stat-text"} -->
					<p class="nh-home-about-us__stat-text">We stay in touch every day and help with orders, care, product selection, and salon clients.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group nh-home-about-us__stat">
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-value"} -->
					<p class="nh-home-about-us__stat-value">13</p>
					<!-- /wp:paragraph -->

					<!-- wp:heading {"level":3,"className":"nh-home-about-us__stat-title"} -->
					<h3 class="nh-home-about-us__stat-title">hair extension formats</h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"className":"nh-home-about-us__stat-text"} -->
					<p class="nh-home-about-us__stat-text">A full range of hair extension formats designed for every application method.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group nh-home-about-us__stat">
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-value"} -->
					<p class="nh-home-about-us__stat-value">10 000</p>
					<!-- /wp:paragraph -->

					<!-- wp:heading {"level":3,"className":"nh-home-about-us__stat-title"} -->
					<h3 class="nh-home-about-us__stat-title">bundles in stock</h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"className":"nh-home-about-us__stat-text"} -->
					<p class="nh-home-about-us__stat-text">Presented in 5 curated categories — designed to suit different budgets and professional needs.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group nh-home-about-us__stat">
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-value"} -->
					<p class="nh-home-about-us__stat-value">70+</p>
					<!-- /wp:paragraph -->
					...
					<!-- wp:paragraph {"className":"nh-home-about-us__stat-text"} -->
					<p class="nh-home-about-us__stat-text">Over 100,000 raw hair bundles available — and 13 product types for any method.</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
		...
		<div class="wp-block-group nh-home-about-us__bottom">
			...
			<div class="wp-block-group nh-home-about-us__aside">
				...
				<!-- wp:heading {"level":3,"className":"nh-home-about-us__aside-title"} -->
				<h3 class="nh-home-about-us__aside-title">Own production</h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"className":"nh-home-about-us__aside-text"} -->
				<p class="nh-home-about-us__aside-text">We operate our own production facility, where we fully control every stage of working with hair. Each hair extension is handcrafted, with great attention to detail and consistent results.</p>
				<!-- /wp:paragraph -->

				<!-- wp:paragraph {"className":"nh-text-link nh-home-about-us__aside-link"} -->
				<p class="nh-text-link nh-home-about-us__aside-link"><a href="#">[ LEARN MORE ]</a></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
