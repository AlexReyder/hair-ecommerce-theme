...
<!-- wp:cover {"url":"<?php echo $hero_image_url; ?>","id":0,"dimRatio":40,"customOverlayColor":"#1c1c1c","minHeight":100,"minHeightUnit":"vh","focalPoint":{"x":0.74,"y":0.34},"className":"nh-home-hero","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
<div class="wp-block-cover nh-home-hero" style="min-height:100vh">
	...
	<img class="wp-block-cover__image-background" alt="" src="<?php echo $hero_image_url; ?>" style="object-position:74% 34%" data-object-fit="cover" data-object-position="74% 34%" />
	<div class="wp-block-cover__inner-container">

		<!-- wp:group {"className":"nh-home-hero__shell","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
		<div class="wp-block-group nh-home-hero__shell">

			<!-- wp:group {"className":"nh-home-hero__top","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group nh-home-hero__top">
				<!-- wp:group {"className":"nh-home-hero__contact","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group nh-home-hero__contact">
					<!-- wp:paragraph {"className":"nh-home-hero__phone","lock":{"move":true,"remove":true}} -->
					<p class="nh-home-hero__phone"><a href="tel:+971585988409">+971 58 598 8409</a></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"className":"nh-home-hero__address","lock":{"move":true,"remove":true}} -->
			...
			<!-- wp:group {"className":"nh-home-hero__content","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group nh-home-hero__content">

				<!-- wp:group {"className":"nh-home-hero__aside","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group nh-home-hero__aside">
					<!-- wp:heading {"level":2,"className":"nh-home-hero__secondary-title","lock":{"move":true,"remove":true}} -->
					<h2 class="nh-home-hero__secondary-title">One Brand.<br>Two Expert Directions.</h2>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->

				<!-- wp:group {"className":"nh-home-hero__main","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group nh-home-hero__main">
					<!-- wp:heading {"level":1,"className":"nh-home-hero__title","lock":{"move":true,"remove":true}} -->
					<h1 class="nh-home-hero__title">/ Full-Cycle Hair Brand — Production, Shop &amp; Salon</h1>
					<!-- /wp:heading -->

					<!-- wp:paragraph {"className":"nh-home-hero__text","lock":{"move":true,"remove":true}} -->
					...
					<!-- wp:buttons {"className":"nh-home-hero__actions","lock":{"move":true,"remove":true}} -->
			...
			<!-- wp:group {"className":"nh-home-hero__bottom","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
			<div class="wp-block-group nh-home-hero__bottom">

				<!-- wp:group {"className":"nh-home-hero__features","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group nh-home-hero__features">

					<!-- wp:group {"className":"nh-home-hero__feature","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
					<div class="wp-block-group nh-home-hero__feature">
						<!-- wp:paragraph {"className":"nh-home-hero__feature-text","lock":{"move":true,"remove":true}} -->
				...
				<!-- wp:group {"className":"nh-home-hero__socials","lock":{"move":true,"remove":true},"layout":{"type":"constrained"}} -->
				<div class="wp-block-group nh-home-hero__socials">
					<!-- wp:paragraph {"className":"nh-home-hero__social","lock":{"move":true,"remove":true}} -->
